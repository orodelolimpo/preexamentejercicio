...
public class NuevoEditorial extends JFrame {
...
//	}
	...
	protected void insertarEditorial() {
		try {
			...
			ed.setNombre(nombre);
			ed.setAnio(anio);
			if (this.editorial == null){//este if es porque significa que es una nueva
	...
	public void setEditorial(Editorial e) {
		editorial = e;
		if (e!=null) {
			lblTitulo.setText("Actualizar la Editorial");
